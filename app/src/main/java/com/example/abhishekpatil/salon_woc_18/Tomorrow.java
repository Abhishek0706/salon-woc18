...
public class Tomorrow extends Fragment {
    ...
    private Switch switch1; private TextView name1;private TextView service1;
    private Switch switch2;private TextView name2;private TextView service2;
    private Switch switch3;private TextView name3;private TextView service3;
    private Switch switch4;private TextView name4;private TextView service4;
    private Switch switch5;private TextView name5;private TextView service5;
    private Switch switch6;private TextView name6;private TextView service6;
    private Switch switch7;private TextView name7;private TextView service7;
    private Switch switch8;private TextView name8;private TextView service8;
    private Switch switch9;private TextView name9;private TextView service9;
    private Switch switch10;private TextView name10;private TextView service10;
    private Switch switch11;private TextView name11;private TextView service11;
    private Switch switch12;private TextView name12;private TextView service12;
    private Switch switch13;private TextView name13;private TextView service13;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch1 = (Switch)view.findViewById(R.id.tomorrow_switch1);name1 = (TextView)view.findViewById(R.id.tomorrow_status_time1);service1 = (TextView)view.findViewById(R.id.tomorrow_service_time1);
        switch2 = (Switch)view.findViewById(R.id.tomorrow_switch2);name2 = (TextView)view.findViewById(R.id.tomorrow_status_time2);service2 = (TextView)view.findViewById(R.id.tomorrow_service_time2);
        switch3 = (Switch)view.findViewById(R.id.tomorrow_switch3);name3 = (TextView)view.findViewById(R.id.tomorrow_status_time3);service3 = (TextView)view.findViewById(R.id.tomorrow_service_time3);
        switch4 = (Switch)view.findViewById(R.id.tomorrow_switch4);name4 = (TextView)view.findViewById(R.id.tomorrow_status_time4);service4 = (TextView)view.findViewById(R.id.tomorrow_service_time4);
        switch5 = (Switch)view.findViewById(R.id.tomorrow_switch5);name5 = (TextView)view.findViewById(R.id.tomorrow_status_time5);service5 = (TextView)view.findViewById(R.id.tomorrow_service_time5);
        switch6 = (Switch)view.findViewById(R.id.tomorrow_switch6);name6 = (TextView)view.findViewById(R.id.tomorrow_status_time6);service6 = (TextView)view.findViewById(R.id.tomorrow_service_time6);
        switch7 = (Switch)view.findViewById(R.id.tomorrow_switch7);name7 = (TextView)view.findViewById(R.id.tomorrow_status_time7);service7 = (TextView)view.findViewById(R.id.tomorrow_service_time7);
        switch8 = (Switch)view.findViewById(R.id.tomorrow_switch8);name8 = (TextView)view.findViewById(R.id.tomorrow_status_time8);service8 = (TextView)view.findViewById(R.id.tomorrow_service_time8);
        switch9 = (Switch)view.findViewById(R.id.tomorrow_switch9);name9 = (TextView)view.findViewById(R.id.tomorrow_status_time9);service9= (TextView)view.findViewById(R.id.tomorrow_service_time9);
        switch10 = (Switch)view.findViewById(R.id.tomorrow_switch10);name10 = (TextView)view.findViewById(R.id.tomorrow_status_time10);service10 = (TextView)view.findViewById(R.id.tomorrow_service_time10);
        switch11 = (Switch)view.findViewById(R.id.tomorrow_switch11);name11 = (TextView)view.findViewById(R.id.tomorrow_status_time11);service11 = (TextView)view.findViewById(R.id.tomorrow_service_time11);
        switch12 = (Switch)view.findViewById(R.id.tomorrow_switch12);name12 = (TextView)view.findViewById(R.id.tomorrow_status_time12);service12 = (TextView)view.findViewById(R.id.tomorrow_service_time12);
        switch13 = (Switch)view.findViewById(R.id.tomorrow_switch13);name13 = (TextView)view.findViewById(R.id.tomorrow_status_time13);service13 = (TextView)view.findViewById(R.id.tomorrow_service_time13);
